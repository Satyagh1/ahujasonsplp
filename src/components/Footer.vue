<template>
  <footer>
    <div class="footer-divider-logo-wrapper">
      <div class="footer-divider-logo">
    ...
    <div class="footer">
      <div class="first-footer">
        <div class="footer-col" v-for="(item, index) in items" :key="index">
          <h2 @click="toggleAcc(index)">
            <span :class="[checkAcc == index ? 'transform' : '']"
              >{{ item.header }}<img src="../assets/Img/down-arrow.png" alt=""
            /></span>
          </h2>
          <ul
            :class="[
              checkAcc == index ? 'list-foot footer-active' : 'list-foot',
            ]"
          >
      ...
      <div class="footer-col-last">
        ...
        <div class="footer-social-media_container">
          ...
          <div class="social-media">
            <a href="#"><img src="../assets/Img/facebook.png" alt="image" /></a>
            <a href="#"
              ><img src="../assets/Img/instagram.png" alt="image"
            /></a>
            <a href="#"><img src="../assets/Img/twitter.png" alt="image" /></a>
            <a href="#"><img src="../assets/Img/linkedin.png" alt="image" /></a>
            <a href="#"
              ><img src="../assets/Img/pinterest.png" alt="image"
            /></a>
  ...
  data() {
    return {
      ...
      items: [
        {
          header: "SHOP",
          content: ["Men", "Women", "Home", "Sale", "Collection"],
        },
        {
          header: "QUICK LINKS",
          content: [
